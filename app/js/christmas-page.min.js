...
var _christmas_page = _interopRequireDefault(require("./modules/christmas_page"));
...
window.christmasLights = new _christmas_page.default({
  ...
  style_content: _christmas_style.christmas_style_page
});

},{"./modules/christmas_page":3,"./modules/christmas_style":4}],2:[function(require,module,exports){
"use strict";
...
var ChristmasLightsPage =
/*#__PURE__*/
function (_ChristmasLights) {
  _inherits(ChristmasLightsPage, _ChristmasLights);

  function ChristmasLightsPage(param) {
    _classCallCheck(this, ChristmasLightsPage);

    return _possibleConstructorReturn(this, _getPrototypeOf(ChristmasLightsPage).call(this, param));
  } // Создание блока управления


  _createClass(ChristmasLightsPage, [{
    key: "initControls",
    value: function initControls() {
      // Кнопка обновления позиции фонариков
      var btn_update = document.createElement('div');
    ...
    key: "init",
    value: function init() {
      _get(_getPrototypeOf(ChristmasLightsPage.prototype), "init", this).call(this); // Запуск создания блока управления
  ...
  return ChristmasLightsPage;
}(_christmas_main.default);

exports.default = ChristmasLightsPage;

},{"./christmas_main":2}],4:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=maps/christmas-page.min.js.map
